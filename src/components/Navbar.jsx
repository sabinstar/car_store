    ...
    <header className=" fixed w-full z-10 bg-secondary text-white py-4">
      ...
      <nav className='container flex justify-between items-center'>
        ...
        <div className='hidden md:flex items-center gap-8 font-medium text-xl'>
          ...
          <Link to="/signUp" className="hover:text-primary transition duration-200 ease-linear hidden lg:flex border-2 border-primary text-lg px-4 rounded-md hover:bg-primary transition duration-200 ease-linear">
            Sign In
          </Link>
        </div>
