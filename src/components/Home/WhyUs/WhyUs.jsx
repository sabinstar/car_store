  ...
  return (
    <div className="flex flex-col justify-center container md:mt-16 py-10">
      <h1 className=" font-bold text-4xl text-center">
        Why choose <span className=" text-primary">Car Store </span>?
      </h1>
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 gap-5">
        <WhyUsCard icon={icon1} title="Special Financing Offers" />
        <WhyUsCard icon={icon2} title="Expert Car Service" />
        <WhyUsCard icon={icon3} title="Transparent Pricing" />
      </div>
    </div>
  );
};
